...
type ContainerAction = "start" | "stop" | "edit" | "restart" | "delete";
            ...
            actions={[
                ...
                <Tooltip title="Delete Container" key="delete">
                    <Button
                        ...
                        icon={<DeleteOutlined />}
                        onClick={() => {
                            setContainerToDelete(container); // <-- Correctly sets the container to delete
                            setDeleteModalVisible(true);     // <-- Displays the modal
                        }}
                ...
                <div className="action-buttons">
                    ...
                    <Tooltip title="Delete Container">
                        <Button
                            ...
                            icon={<DeleteOutlined />}
                            onClick={() => {
                                setContainerToDelete(record); // <-- Correctly sets the container to delete
                                setDeleteModalVisible(true);  // <-- Displays the modal
                            }}
